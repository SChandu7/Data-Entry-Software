...
/// ---------------------------------------------------------------
/// Replace these two URLs with your actual image URLs.
/// ---------------------------------------------------------------
const _emblemUrl =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS393_22eG8-Ty3A7YK9qFQFwxxQkhVLJPxZA&s'; // e.g. a direct link to the unit emblem
const _personUrl =
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9Ys1oiWHvDhqxz19KEPfJMHGLb8Ce5QNlbA&s'; // e.g. a direct link to the CO photo
/// ---------------------------------------------------------------
...
class SplashScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        fit: StackFit.expand,
        children: [
          // Subtle radial gradient to match the reference background
          Container(
  ...
  // Placeholder shown when emblem URL is not set
  ...
  // Placeholder shown when person URL is not set
