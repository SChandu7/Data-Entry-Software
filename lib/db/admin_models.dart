...
class LeaveRecord {
  ...
  Map<String, dynamic> toMap() => {
        ...
        'to_dt': toDt,
        'days': days,
        'reporting_dt': reportingDt,
        'remarks': remarks,
        'created_at': createdAt
      };
  factory LeaveRecord.fromMap(Map<String, dynamic> m) =>
      LeaveRecord(armyNo: m['army_no'] ?? '', id: m['id'])
        ..leaveType = m['leave_type']
        ..fromDt = m['from_dt']
        ..toDt = m['to_dt']
        ..days = m['days']
        ..reportingDt = m['reporting_dt']
        ..remarks = m['remarks']
...
class EreRecord {
  ...
  factory EreRecord.fromMap(Map<String, dynamic> m) =>
      EreRecord(armyNo: m['army_no'] ?? '', id: m['id'])
        ..ereUnit = m['ere_unit']
        ..appointment = m['appointment']
        ..fromDt = m['from_dt']
        ..toDt = m['to_dt']
        ..returnDt = m['return_dt']
        ..remarks = m['remarks']
        ..createdAt = m['created_at'];
}
...
class HealthRecord {
  ...
  factory HealthRecord.fromMap(Map<String, dynamic> m) =>
      HealthRecord(armyNo: m['army_no'] ?? '', id: m['id'])
        ..category = m['category']
        ..medCat = m['med_cat']
        ..medCatDetail = m['med_cat_detail']
        ..diag = m['diag']
        ..hospital = m['hospital']
        ..boardDt = m['board_dt']
        ..dueOn = m['due_on']
...
class OutStrengthRecord {
  ...
  factory OutStrengthRecord.fromMap(Map<String, dynamic> m) =>
      OutStrengthRecord(armyNo: m['army_no'] ?? '', id: m['id'])
        ..reason = m['reason']
        ..location = m['location']
        ..fromDt = m['from_dt']
...
class FiringRecord {
  ...
  FiringRecord({required this.armyNo, this.id});
  Map<String, dynamic> toMap() =>
      {'id': id, 'army_no': armyNo, 'result': result, 'created_at': createdAt};
  factory FiringRecord.fromMap(Map<String, dynamic> m) =>
      FiringRecord(armyNo: m['army_no'] ?? '', id: m['id'])
        ..result = m['result']
        ..createdAt = m['created_at'];
}
...
class CptRecord {
  ...
  String armyNo;
  String? result, createdAt;
  CptRecord({required this.armyNo, this.id});
  Map<String, dynamic> toMap() =>
      {'id': id, 'army_no': armyNo, 'result': result, 'created_at': createdAt};
  factory CptRecord.fromMap(Map<String, dynamic> m) =>
      CptRecord(armyNo: m['army_no'] ?? '', id: m['id'])
        ..result = m['result']
        ..createdAt = m['created_at'];
}
