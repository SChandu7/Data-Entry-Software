...
class JcoRetiredCard extends StatefulWidget {
  ...
  const JcoRetiredCard({super.key, this.record, required this.onSaved});
  @override
...
class _JcoRetiredCardState extends State<JcoRetiredCard> {
  ...
  final _singAcct=TextEditingController(); final _singBank=TextEditingController(); final _singCode=TextEditingController();
  final _jntAcct=TextEditingController(); final _jntBank=TextEditingController(); final _jntCode=TextEditingController();
  ...
  final _pSub=TextEditingController(); final _pSubMaj=TextEditingController(); final _pAcp=TextEditingController();
  ...
  void dispose() {
    for(final c in [_armyNo,_name,_dob,_doe,_dor,_tos,_sos,_returnDt,_rrEre,_icard,
        ...
        _father,_mother,_wife,_nok,
        _singAcct,_singBank,_singCode,_jntAcct,_jntBank,_jntCode,
  ...
  void _populate(JcoOrModel r) {
    ...
    _sos.text=r.sos??'';_returnDt.text=r.returnDt??'';_rrEre.text=r.rrEreFmn??'';
    _icard.text=r.icardNo??'';_honours.text=r.honoursAwards??'';_pan.text=r.panCardNo??'';
    ...
    _singAcct.text=r.singleAcctNo??'';_singBank.text=r.singleBankName??'';_singCode.text=r.singleCodeNo??'';
    _jntAcct.text=r.jointAcctNo??'';_jntBank.text=r.jointBankName??'';_jntCode.text=r.jointCodeNo??'';
    ...
    setState((){_rank=r.rank;_coy=r.coy;_bloodGp=r.bloodGp;_photoPath=r.photoPath;
      _chS[0]=r.ch1Sex;_chS[1]=r.ch2Sex;_chS[2]=r.ch3Sex;_chS[3]=r.ch4Sex;
      _eMr1=r.eMr1;_eMr2=r.eMr2;_eMr3=r.eMr3;_eAce1=r.eAce1;_eAce2=r.eAce2;
      _eAce3=r.eAce3;_eAec3=r.eAec3;_eTtt1=r.eTtt1;_eTtt2=r.eTtt2;_eTtt3=r.eTtt3;
  ...
  void _clear() {
    ...
    setState((){_rank=null;_coy=null;_bloodGp=null;_photoPath=null;
      ...
      for(int i=0;i<5;i++) _dEnt[i]=null;_discRows=1;});
  }

  JcoOrModel _buildModel() {
    final m=JcoOrModel(subCategory:SubCat.jcoRetired,id:widget.record?.id);
    ...
    m.singleAcctNo=_singAcct.text.trim();m.singleBankName=_singBank.text.trim();m.singleCodeNo=_singCode.text.trim();
    m.jointAcctNo=_jntAcct.text.trim();m.jointBankName=_jntBank.text.trim();m.jointCodeNo=_jntCode.text.trim();
    ...
    m.eMr1=_eMr1;m.eMr2=_eMr2;m.eMr3=_eMr3;m.eAce1=_eAce1;m.eAce2=_eAce2;
    m.eAce3=_eAce3;m.eAec3=_eAec3;m.eTtt1=_eTtt1;m.eTtt2=_eTtt2;m.eTtt3=_eTtt3;
  ...
  Widget _ednDd(String l,String? val,void Function(String?) cb)=>SizedBox(width:118,
    child:Column(crossAxisAlignment:CrossAxisAlignment.start,mainAxisSize:MainAxisSize.min,children:[
      Padding(padding:const EdgeInsets.only(bottom:4),child:Text(l.toUpperCase(),style:kLabelStyle)),
      DropdownButtonFormField<String>(value:val,isExpanded:true,style:kFieldStyle.copyWith(color:kInk),
          items:kPassFail.map((o)=>DropdownMenuItem(value:o,child:Text(o,style:kFieldStyle))).toList(),onChanged:cb)]));
  ...
  Widget build(BuildContext context){
    return Column(children:[
      Container(width:double.infinity,padding:const EdgeInsets.symmetric(vertical:10,horizontal:14),
        ...
        child:const Text('RETD JCOs OR : DATA CARD',style:TextStyle(fontSize:15,fontWeight:FontWeight.w900,letterSpacing:.4,color:kSlate))),
      ...
      CardSection(title:'Pers Details',child:Column(children:[Row(crossAxisAlignment:CrossAxisAlignment.start,children:[
        Expanded(child:Wrap(spacing:14,runSpacing:14,children:[
          ...
          _fDate('DOR',_dor,w:150),_fDate('TOS',_tos,w:150),_fDate('SOS',_sos,w:150),_fDate('Return Dt',_returnDt,w:160),
      ...
      CardSection(title:'Bank Details',child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
        ...
        Wrap(spacing:14,runSpacing:14,children:[_f('Acct No',_singAcct,w:230),_f('Bank Name',_singBank,w:280),_f('Code No',_singCode,w:160)]),
        const SizedBox(height:10),const SubLabel('Joint Account'),
        Wrap(spacing:14,runSpacing:14,children:[_f('Acct No',_jntAcct,w:230),_f('Bank Name',_jntBank,w:280),_f('Code No',_jntCode,w:160)]),
      ])),
      ...
      CardSection(title:'Army Edn',child:Wrap(spacing:14,runSpacing:14,children:[
        _ednDd('MR-I',_eMr1,(v)=>setState(()=>_eMr1=v)),_ednDd('MR-II',_eMr2,(v)=>setState(()=>_eMr2=v)),
        _ednDd('MR-III',_eMr3,(v)=>setState(()=>_eMr3=v)),_ednDd('ACE-I',_eAce1,(v)=>setState(()=>_eAce1=v)),
        _ednDd('ACE-II',_eAce2,(v)=>setState(()=>_eAce2=v)),_ednDd('ACE-III',_eAce3,(v)=>setState(()=>_eAce3=v)),
        _ednDd('AEC-III',_eAec3,(v)=>setState(()=>_eAec3=v)),_ednDd('TTT-I',_eTtt1,(v)=>setState(()=>_eTtt1=v)),
        _ednDd('TTT-II',_eTtt2,(v)=>setState(()=>_eTtt2=v)),_ednDd('TTT-III',_eTtt3,(v)=>setState(()=>_eTtt3=v)),
      ])),
