...
class _JcoOnEreCardState extends State<JcoOnEreCard> implements CardController {
  ...
  JcoOrModel _buildModel() {
    final m = JcoOrModel(
        subCategory: SubCat.jcoOnEre, id: widget.record?.id ?? _savedId);
    ...
    return Column(children: [
      ...
      CardSection(
          ...
          child:
            ...
            Wrap(spacing: 14, runSpacing: 14, children: [
              _f('Acct No', _singAcct, w: 240),
              _f('Bank Name', _singBank, w: 310)
            ]),
            const SizedBox(height: 10),
            const SubLabel('Joint Account'),
            Wrap(spacing: 14, runSpacing: 14, children: [
              _f('Acct No', _jntAcct, w: 240),
              _f('Bank Name', _jntBank, w: 310)
            ]),
          ])),
      CardSection(
          title: 'Home Address',
