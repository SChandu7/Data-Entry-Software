                      ...
                      child: SingleChildScrollView(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 10),
                                _dd('Rank', _rank, kAllRanks, (v) {
                                  setState(() => _rank = v);
                                  _runSearch();
                                }),
                                const SizedBox(height: 10),
                                _dd('Blood Group', _bloodGp, kBlood, (v) {
                                  setState(() => _bloodGp = v);
                                  _runSearch();
                                }),
                                const SizedBox(height: 10),
                                _dd('Age', _ageBracket, _ageBrackets, (v) {
                                  setState(() => _ageBracket = v);
                                  _runSearch();
                                }),
                                const SizedBox(height: 10),
                                _dd('Domicile', _domicile, kDomicile, (v) {
                                  setState(() => _domicile = v);
                                  _runSearch();
                                }),
                                const SizedBox(height: 10),
                                _dd('Civ Education', _civEdn, kEducation, (v) {
                                  setState(() => _civEdn = v);
                                  _runSearch();
                                }),
                                const SizedBox(height: 10),
                                ...
                                _chk('Leave Record', _hasLeave, (v) {
                                  setState(() => _hasLeave = v ?? false);
                                  _runSearch();
                                }),
                                _chk('Health Record', _hasHealth, (v) {
                                  setState(() => _hasHealth = v ?? false);
                                  _runSearch();
                                }),
                                _chk('ERE Record', _hasEre, (v) {
                                  setState(() => _hasEre = v ?? false);
                                  _runSearch();
                                }),
                                _chk('Out Strength Record', _hasOutStr, (v) {
                                  setState(() => _hasOutStr = v ?? false);
                                  _runSearch();
                                }),
                                _chk('Firing Record', _hasFiring, (v) {
                                  setState(() => _hasFiring = v ?? false);
                                  _runSearch();
                                }),
                                _chk('CPT Record', _hasCpt, (v) {
