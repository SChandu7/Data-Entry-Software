...
class EducationView extends StatefulWidget {
  ...
  const EducationView({super.key, required this.eduLevel});
  @override
...
class _EducationViewState extends State<EducationView> {
  ...
  String get _title => 'EDUCATION — ${widget.eduLevel.toUpperCase()}';
  ...
  @override
  void didUpdateWidget(EducationView o) {
    super.didUpdateWidget(o);
    if (o.eduLevel != widget.eduLevel) _load();
  }

  Future<void> _load() async {
    setState(() => _loading = true);
    _off = await _db.queryOfficers(civEdn: widget.eduLevel);
    _jco = await _db.queryJco(civEdn: widget.eduLevel);
