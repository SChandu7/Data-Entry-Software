...
class FiringView extends StatefulWidget {
  const FiringView({super.key});
  @override
  State<FiringView> createState() => _FiringViewState();
}

class _FiringViewState extends State<FiringView> {
  ...
  static const _title = 'MISCELLANEOUS — FIRING RESULTS';
  ...
  Future<void> _load() async {
    ...
    _rows = await _db.getFiringReport();
