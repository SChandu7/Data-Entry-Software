...
class EreView extends StatefulWidget {
  final String subKey;
  const EreView({super.key, required this.subKey});
  @override
  State<EreView> createState() => _EreViewState();
}

class _EreViewState extends State<EreView> {
  final _db = AppDatabase.instance;
  List<Map<String, dynamic>> _rows = [];
  bool _loading = true;
  String get _title =>
      'ERE RECORDS — ${EreSub.label(widget.subKey).toUpperCase()}';
  ...
  @override
  void didUpdateWidget(EreView o) {
  ...
  Future<void> _load() async {
    ...
    final status = widget.subKey == EreSub.all ? null : widget.subKey;
    _rows = await _db.getEreReport(status: status);
