...
class OutStrView extends StatefulWidget {
  final String subKey;
  const OutStrView({super.key, required this.subKey});
  @override
  State<OutStrView> createState() => _OutStrViewState();
}

class _OutStrViewState extends State<OutStrView> {
  final _db = AppDatabase.instance;
  List<Map<String, dynamic>> _rows = [];
  bool _loading = true;
  String get _title =>
      'OUT STRENGTH — ${OutStrSub.label(widget.subKey).toUpperCase()}';
  ...
  @override
  void didUpdateWidget(OutStrView o) {
  ...
  Future<void> _load() async {
    ...
    _rows = await _db.getOutStrReport(reason: OutStrSub.dbVal(widget.subKey));
